...
// Create an interface of the dex contract so it can interact with the flashloan contract.
// Lists out the function signatures that will be used.
interface IDex {
...
contract FlashLoanArbitrage is FlashLoanSimpleReceiverBase {
    ...
    // Aave specific versions of the tokens which need to be used for testing.
    ...
    // Instantiating new instances of the token + the dex contract
